...
function Transfer({ selectedToken, setAction, walletAddress, thirdWebToken }) {
  ...
  useEffect(() => {
    const activeToken = thirdWebToken.find(
  ...
  const sendCrypto = async () => {
    if (activeThirdWebToken && amount && recipientAddress) {
